...
require_pattern ".github/workflows/build_and_release_image.yml" "repository-dispatch@v3" "dev auto deploy dispatch"
require_pattern ".github/workflows/build_and_release_image.yml" "Prod deploy is manual-only" "manual-only prod deployment"
require_pattern ".github/workflows/build_and_release_image.yml" "docker/build-push-action@v6" "current Docker build action"
